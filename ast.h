...
public:
  ...
  // return first token
  Token first_token() {return type_id;}  
  // visitor access
  void accept(Visitor& v) {v.visit(*this);}
};  
...
public:
  ...
  // return first token
  Token first_token() {return function_id;}  
  // visitor access
  void accept(Visitor& v) {v.visit(*this);}
};  
...
public:
  ...
  // return first token
  Token first_token() {return path.front();}  
  // visitor access
  void accept(Visitor& v) {v.visit(*this);}
};  
...
class PointerType : public RValue
{
  public:
  Token pointer;
  // return first token
  Token first_token() {return pointer;}  
  // visitor access
  void accept(Visitor& v) {v.visit(*this);}
};

class PointerValue : public RValue
{
public:
  Token pointer;
  // return first token
